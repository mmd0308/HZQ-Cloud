...
import com.hzqing.system.rest.converter.ServeConverter;
...
public class ServeController extends BaseController {
    ...
    public RestResult<Boolean> checkPermission(@PathVariable String permission,String id){
        CommonResponse<Boolean> response = serveService.checkPermission(new PermissionRequest(permission, id));
